...
MAX_CLASS_NUMBER = 5 # count of classes

P_LBL_PATH = r"E:\0324_only_traffic\lbl"
            ...
            if "type" in key_list and "direction" in key_list:
                try:
                    if i["type"] == "car" and i["direction"] == "horizontal":
                        ...
                        if add_num == 99 and light_count < 3 and light_count > 4:
                            break
                        mul_num = light_count
                ...
                if "light_count" in key_list:
                    ...
                    if light_count >= 3:
                        ...
                        # class_num = 5 * (light_count - 1) + add_num
                        class_num = add_num
                        if class_num > MAX_CLASS_NUMBER and light_count < 3 and light_count > 4:
                            break
                        save_str = f"{class_num} {x} {y} {width} {height}"
                        TL_list.append(save_str)
